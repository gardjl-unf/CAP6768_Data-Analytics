...
class Regression:
    def __init__(self, data: np.ndarray) -> None:
        ...
        self.linear_model, self.quadratic_model, self.degree_10_model, self.degree_20_model = self._fit_models()
    ...
    def _fit_models(self):
        ...
        return linear_model, quadratic_model, degree_10_model, degree_20_model
    ...
    def get_models(self):
        return self.linear_model, self.quadratic_model, self.degree_10_model, self.degree_20_model
...
if __name__ == "__main__":
    ...
    linear_model, quadratic_model, degree_10_model, degree_20_model = regression.get_models()
    ...
    plt.plot(X_sorted, Y_pred_degree_20_sorted, color='purple', label='Degree-20 Polynomial Regression')
    plt.xlabel('Average Asking Rent ($)')
    plt.ylabel('Monthly Mortgage on Median-Priced Home ($)')
    plt.title('Comparison of Linear, Quadratic, Degree-10, and Degree-20 Polynomial Regression Models')
    plt.legend()
    plt.savefig('regression_comparison_all.png')
    plt.close()
    
    # Extract regression equations
    (linear_coef, linear_intercept), (quad_intercept, quad_coef_x, quad_coef_x2), degree_10_coefs, degree_20_coefs = regression.get_equations()
